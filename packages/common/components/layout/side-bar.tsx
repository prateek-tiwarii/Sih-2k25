...
import { IconArrowBarLeft, IconArrowBarRight, IconChartBar, IconPlus, IconSearch } from '@tabler/icons-react';
...
export const Sidebar = () => {
    ...
    console.log('🔧 Sidebar: Rendering, isSidebarOpen =', isSidebarOpen, 'pathname =', pathname);
